...
void FXOS8700CQStandby(void)
{
    uint8_t ui8Register;
    ui8Register = I2CReceive(I2C0_BASE, FXOS8700CQ_SLAVE_ADDR, FXOS8700CQ_CTRL_REG1);
    ui8Register &= ~(0B00000001);
    I2CSend(I2C0_BASE, FXOS8700CQ_SLAVE_ADDR, 2, FXOS8700CQ_CTRL_REG1, ui8Register);
}

void FXOS8700CQActive(void)
{
    uint8_t ui8Register;
    ui8Register = I2CReceive(I2C0_BASE, FXOS8700CQ_SLAVE_ADDR, FXOS8700CQ_CTRL_REG1);
    ui8Register |= 0B00000001;
...
void FXOS8700CQAccelRange(tAccelRange tAFSR)
{
    uint8_t ui8Register;
    ui8Register = I2CReceive(I2C0_BASE, FXOS8700CQ_SLAVE_ADDR, FXOS8700CQ_XYZ_DATA_CFG);
    ui8Register &= ~(0B00000011);
    ui8Register |= tAFSR;
    I2CSend(I2C0_BASE, FXOS8700CQ_SLAVE_ADDR, 2, FXOS8700CQ_XYZ_DATA_CFG, ui8Register);
}

void FXOS8700CQOutputDataRate(tOutputDataRate tODR)
{
    uint8_t ui8Register;
    ui8Register = I2CReceive(I2C0_BASE, FXOS8700CQ_SLAVE_ADDR, FXOS8700CQ_CTRL_REG1);
